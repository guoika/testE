...
export class ExamService {
    ...
    list(): Observable<any> {
        return this.http.get(`${this.API_URL}/api/exam?VisitId=0&ProblemId=0`).pipe(map((result: any) => result.Payload));
    }
    getS() {
      return  [
        {
    ...
    delete(id): Observable<any> {
        return this.http.delete(`${this.API_URL}/api/exam/${id}`).pipe(map((result: any) => result.Payload));
    }
    edit(data, id): Observable<any> {
      return this.http.put(`${this.API_URL}/api/exam/${id}`, data).pipe(map((result: any) => result.Payload));
    }
    create(data): Observable<any> {
        return this.http.post(`${this.API_URL}/api/exam`, data).pipe(map((result: any) => result.Payload));
    }
}
